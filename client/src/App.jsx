...
function App() {
  return (
    ...
    <header className='justify-between flex'>
        ...
        <div className='flex border gap-4 border-red-600 rounded-full shadow-lg shadow-700 py-2 px-4'>
            <div>My Place</div>
        ...
        <div className='flex gap-2 border border-red-400 rounded-full py-2 px-4'>
